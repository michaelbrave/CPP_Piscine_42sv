...
{
    std::cout << "FR4G-TP " << _name << " attacks " << target << " with ranged attack, causing " << this->_ranged_attack_damage << " points of damage!" << std::endl;
    return (this->_ranged_attack_damage);
};
int FragTrap::meleeAttack(std::string const & target)
{
    std::cout << "FR4G-TP " << _name << " attacks " << target << " with melee attack, causing " << this->_melee_attack_damage << " points of damage!" << std::endl;
...
int FragTrap::specialAttack(std::string const & target)
{
    ...
    std::cout << "FR4G-TP " << _name << " attacks " << target << " with special attack, causing " << damage << " points of damage!" << std::endl;
    return (damage);
}
int FragTrap::kamehamehaAttack(std::string const & target)
{
    int damage = randomizer(7, 30);
    std::cout << "FR4G-TP " << _name << " attacks " << target << " with kamehameha attack, causing " << damage << " points of damage!" << std::endl;
    return (damage);
}
int FragTrap::frostBreathAttack(std::string const & target)
{
    int damage = randomizer(8, 35);
    std::cout << "FR4G-TP " << _name << " attacks " << target << " with frost breath attack, causing " << damage << " points of damage!" << std::endl;
    return (damage);
}
int FragTrap::ultimateTechniqueAttack(std::string const & target)
{
    int damage = randomizer(10, 45);
    std::cout << "FR4G-TP " << _name << " attacks " << target << " with ultimate technique attack, causing " << damage << " points of damage!" << std::endl;
    return (damage);
}
int FragTrap::oneThousandYearsOfDeathAttack(std::string const & target)
{
    int damage = randomizer(15, 55);
    std::cout << "FR4G-TP " << _name << " attacks " << target << " with one thousand years of death technique, causing " << damage << " points of damage!" << std::endl;
    return (damage);
}
